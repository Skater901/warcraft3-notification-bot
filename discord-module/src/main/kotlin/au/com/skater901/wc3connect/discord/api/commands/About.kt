...
internal class About : Command {
    ...
    override suspend fun handleCommand(command: SlashCommandInteractionEvent) {
        ...
        command.replySuspended("This bot was created by @Skater901. For help with the bot, please contact him. The source code for the bot can be found [here](https://github.com/Skater901/wc3connect-notification-bot), if you are curious.")
    }
}