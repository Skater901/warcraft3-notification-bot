...
/**
 * The interface to implement to handle notification of Warcraft 3 games being hosted and unhosted.
 */
public interface GameNotifier {
     ...
     * implementation.
     *
     * @param game The details about the hosted Warcraft 3 game.
     *
     * @throws [au.com.skater901.wc3.api.core.domain.exceptions.InvalidNotificationException]
     */
